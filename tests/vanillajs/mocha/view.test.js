(function(describe, it, expect) {
  ...
  describe("View", function() {
    ...
    it("showEntries displays all todos", function() {
      ...
      expect(document.querySelector("#todo-list > :nth-child(1)").innerText.trim())
        .to.equal("_MODEL1_");
      expect(document.querySelector("#todo-list > :nth-child(2)").innerText.trim())
        .to.equal("_MODEL2_");
      expect(document.querySelector("#todo-list > :nth-child(3)").innerText.trim())
        .to.equal("_MODEL3_");
    });
